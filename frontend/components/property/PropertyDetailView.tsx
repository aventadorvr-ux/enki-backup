              ...
              <CardContent className="p-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-white/80 text-white/70">Bedrooms</p>
                  </div>
                  <div className="text-center">
                    <Bath className="h-6 w-6 mx-auto mb-2 text-primary" />
                    <p className="text-2xl font-bold">{property.bathrooms}</p>
                    <p className="text-sm text-white/80 text-white/70">Bathrooms</p>
                  </div>
                  <div className="text-center">
                    ...
                    <p className="text-sm text-white/80 text-white/70">Sq Ft</p>
                  </div>
                  <div className="text-center">
                    <Home className="h-6 w-6 mx-auto mb-2 text-primary" />
                    <p className="text-2xl font-bold">{property.propertyType}</p>
                    <p className="text-sm text-white/80 text-white/70">Type</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/80 text-white/70">
